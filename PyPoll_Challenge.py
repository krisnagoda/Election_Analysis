...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (cvotes > voter_turnout_count) and (cvote_percentage > voter_turnout_percentage):

            voter_turnout_count = cvotes
    ...
    largest_county_summary = (
        ...
        # f"Winning Vote Count: {voter_turnout_count:,}\n"
        # f"Winning Percentage: {voter_turnout_percentage:.1f}%\n"
        f"-------------------------\n")
